function showTermDef(searchTerm)	{
	...
	for (i=0;i<x.length;i++)	{
		//if(x[i].getElementsByTagName("Term")[0].childNodes[0].nodeValue.toLowerCase() == document.getElementById("query").toLowerCase)	{
		if(x[i].getElementsByTagName("Term")[0].childNodes[0].nodeValue.toLowerCase() == 'bankruptcy')	{
